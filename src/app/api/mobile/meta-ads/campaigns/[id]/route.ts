...
export async function GET(_request: NextRequest, { params }: RouteParams) {
  ...
  const params2 = new URLSearchParams({
    fields: [
      ...
      "created_time",
      "buying_type",
      "lifetime_insights:insights.date_preset(maximum){spend,impressions,reach,clicks,ctr,cpc,cpm,account_currency}",
      "daily_insights:insights.date_preset(last_30d).time_increment(1){date_start,spend,impressions,reach,clicks}",
      "last7_insights:insights.date_preset(last_7d){spend,impressions,reach,clicks,ctr,account_currency}",
