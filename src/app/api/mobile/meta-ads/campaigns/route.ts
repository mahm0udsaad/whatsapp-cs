...
export async function GET() {
  ...
  const params = new URLSearchParams({
    fields: [
      ...
      "stop_time",
      "created_time",
      "insights.date_preset(last_7d){spend,impressions,clicks,reach,ctr,account_currency}",
      "lifetime_insights:insights.date_preset(maximum){spend,impressions,reach,account_currency}",
