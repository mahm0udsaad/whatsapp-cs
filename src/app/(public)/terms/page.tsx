...
export const metadata: Metadata = {
  title: "شروط الاستخدام — نِحجز",
  description: "الشروط التي تحكم استخدام لوحة نِحجز وتطبيق نِحجز بوت.",
};
...
export default function TermsPage() {
  return (
    <article className="mx-auto max-w-3xl px-6 py-16 text-gray-700 leading-loose [&_h2]:mt-10 [&_h2]:mb-3 [&_h2]:text-xl [&_h2]:font-bold [&_h2]:text-gray-900 [&_p]:mt-4 [&_ul]:mt-4 [&_ul]:list-disc [&_ul]:pr-6 [&_li]:mt-1 [&_a]:text-emerald-700 [&_a]:underline hover:[&_a]:text-emerald-800">
      ...
      <p>
        تحكم هذه الشروط ("الشروط") وصولك واستخدامك للوحة <strong>نِحجز</strong> على الويب
        وتطبيق نِحجز بوت على الآيفون والأندرويد (يُشار إليهما معاً بـ "الخدمة"). بإنشاء حساب أو
        استخدام الخدمة فإنك توافق على هذه الشروط.
      </p>

      <h2>1. الخدمة</h2>
      <p>
        يوفر نِحجز للمتاجر مساعداً ذكياً للواتساب، ولوحة تحكم، وتطبيق جوّال للموظفين، وأدوات
        لإدارة النشر والإعلانات على فيسبوك وإنستغرام عند ربط حساب Meta، وأدوات تشغيلية مرتبطة.
        يعتمد نِحجز على منصات خارجية (منها Meta WhatsApp Business، Supabase،
      ...
      <p>
        <strong>
          نِحجز بوت خدمة موجَّهة للأعمال التجارية فقط (Business-to-Business).
        </strong>{" "}
      ...
      <p>
        عملية الاشتراك تتم حصراً عبر فريق المبيعات لدينا. لا توجد عملية
        تسجيل ذاتي ولا اشتراك مباشر متاح للجمهور عبر الموقع أو عبر
        تطبيق الجوّال. كل عميل جديد يتواصل مع فريق المبيعات عبر واتساب،
        ويتم تجهيز حسابه يدوياً بعد التحقق من نشاطه التجاري وتوقيع
        الاتفاقية التجارية المناسبة.
      </p>
      <p>
        تطبيق نِحجز بوت على الآيفون والأندرويد لا يحتوي على أي عمليات
        شراء داخل التطبيق، ولا يعرض أسعاراً أو خطط اشتراك، وهو مخصّص
        فقط لتسجيل دخول الموظفين المرتبطين بحساب نشاط تجاري قائم
        ومدفوع. هذا التصميم يتوافق مع إرشادات App Store Review رقم
      ...
      <p>
        ...
        غير متوقعة. أنت مسؤول عن مراجعة الإعدادات وعن أي رد يُرسل من حساب متجرك. لا يضمن نِحجز
      ...
      <p>
        إلى أقصى حد يسمح به النظام، لن يكون نِحجز مسؤولاً عن أي أضرار غير مباشرة أو عرضية أو
