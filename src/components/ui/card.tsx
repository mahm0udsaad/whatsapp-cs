...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[var(--radius-lg)] border border-[var(--line)] bg-[var(--surface)] shadow-[0_12px_32px_-28px_rgba(17,29,87,0.38)]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h2
    ref={ref}
    className={cn(
      "text-lg font-bold leading-tight text-[var(--foreground)]",
      className
    )}
    {...props}
  />
