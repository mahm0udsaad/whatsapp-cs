...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[28px] border border-[#e7dccb] bg-white/94 shadow-[0_30px_80px_-44px_rgba(31,41,55,0.28)] backdrop-blur-sm",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h2
    ref={ref}
    className={cn(
      "text-xl font-semibold leading-none tracking-[-0.02em] text-slate-950",
      className
    )}
    {...props}
  />
